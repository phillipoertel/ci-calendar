...
function ci_calendar_shortcode() {
  ...
  '/public/basic.ics';
    ...
    wp_enqueue_script('my-calendar', plugin_dir_url(__FILE__) . 'calendar.js', [], filemtime(plugin_dir_path(__FILE__) . 'calendar.js'), true);
    wp_enqueue_style('my-calendar', plugin_dir_url(__FILE__) . 'calendar.css', [], filemtime(plugin_dir_path(__FILE__) . 'calendar.css'));
    ...
    <script src="<?php echo esc_url(plugin_dir_url(__FILE__) . 'country-codes.js'); ?>"></script>
